...
const seedData = async () => {
  try {
    ...
    const testimonials = [
      ...
      { name: "Dylan Reed", title: "VP Engineering", company: "LumenOps", quote: "They operated like a core extension of our team, with strong code quality, pragmatic decisions, and clear delivery. Our internal tooling finally keeps up with the business." },
