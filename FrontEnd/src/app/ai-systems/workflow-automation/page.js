...
const outcomes = [
  "Automate repetitive tasks to scale without adding headcount",
  "Implement AI decision-support into your core business logic",
  "Connect fragmented tools into one intelligent operational system",
  "Reduce overhead and eliminate human error across every workflow",
];

const whoFor = [
  "Businesses relying on repetitive manual tasks that slow down growth",
  "Teams working across disconnected tools and fragmented systems",
  "Companies looking to implement AI into their daily business operations",
  "Organizations that want to improve efficiency without increasing payroll",
];
...
const whatWeBuild = [
  {
    ...
    short: "Automations that use AI to process inputs, route tasks, and generate responses.",
    bullets: [
  ...
  },
  {
    ...
    short: "Seamless integrations between CRMs, dashboards, and communication tools.",
    bullets: [
  ...
  },
  {
    ...
    short: "Internal systems that help teams handle requests and complete work faster.",
    bullets: [
...
const steps = [
  {
    number: "01",
    phase: "Process Review",
    title: "Identify bottlenecks and automation opportunities",
    description:
      "We audit your current operations to find repetitive tasks and manual bottlenecks where AI and automation can have the highest impact.",
    detail: "Operations Audit → Bottleneck Analysis → Automation Strategy",
  },
  {
    number: "02",
    phase: "Workflow Design",
    title: "Design the logic, AI components, and integrations",
    description:
      "We architect the intelligent workflow layer, defining how AI will process information and how systems will communicate to achieve your outcomes.",
    detail: "System Mapping → AI Component Design → Integration Spec",
  },
  {
    number: "03",
    phase: "Implementation",
    title: "Build and connect your automation systems",
    description:
      "We build and deploy the production-ready automations, ensuring they are reliable, secure, and fully integrated into your existing tech stack.",
    detail: "Production Build → Security Verification → System Deployment",
  },
  {
    number: "04",
    phase: "Optimization & Expansion",
    title: "Refine results and scale your intelligent operations",
    description:
      "We monitor performance and continuously refine AI accuracy and workflow efficiency as your business grows and your needs evolve.",
    detail: "Performance Monitoring → AI Refinement → System Expansion",
  },
];

const why = [
  "Reduced operational overhead and lower cost-per-task",
  "Increased team capacity without increasing headcount",
  "Eliminate manual errors through reliable automated logic",
  "Fast implementation focused on real business ROI",
];
      ...
      >
        ...
        >
          ...
          <h1 className="font-serif font-bold leading-[1.05] tracking-tight text-white mb-6 text-[clamp(2.5rem,6.3vw,5.85rem)]">
            <SplitReveal text="AI Workflow Automation" delay={0.6} className="block" />
            <SplitReveal
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="font-serif font-bold text-white text-[clamp(1.8rem,3.5vw,3.5rem)] leading-[1.05] tracking-tight mb-6">
                Redundant work stops{" "}
                <em className="not-italic text-brand-gold">great teams from scaling.</em>
              </h2>
              <p className="text-slate-400 leading-relaxed text-sm font-times mb-6">
                Manual work slows teams down. We help businesses automate repetitive 
                processes, connect disconnected systems, and implement AI into 
                day-to-day operations so teams can move faster with less overhead.
              </p>
              <p className="text-slate-400 leading-relaxed text-sm font-times italic">
                You are not just automating steps; you are building an intelligent 
                operational backbone for your business.
              </p>
            </motion.div>
      ...
      <section className="relative z-10 py-24">
        ...
        <div ref={whoRef} className="relative z-10 w-full px-36">
          ...
          <div className="flex items-center justify-between gap-4 mb-16">
            ...
            >
              Teams that are{" "}
              <em className="not-italic text-brand-gold">done doing it manually.</em>
            </motion.h2>
            <motion.span
              initial={{ opacity: 0 }}
            ...
            <div className="grid lg:grid-cols-2 gap-0">
              ...
              <div className="p-12 lg:p-16 border-b lg:border-b-0 lg:border-r border-white/[0.06] flex flex-col justify-center">
                ...
                <p className="text-slate-400 text-sm leading-relaxed font-times max-w-sm">
                  We don&apos;t sell small task automation. We sell operational 
                  improvements. Every engagement is scoped based on the complexity 
                  of the AI components and system integrations.
                </p>
              </div>
      ...
      <section className="relative z-10 py-32">
        ...
        <div ref={whyRef} className="relative z-10 w-full px-36">
          ...
          <div className="flex items-center justify-between gap-4 mb-16">
            ...
            >
              Automation is a{" "}
              <em className="not-italic text-brand-gold">business lever.</em>
            </motion.h2>
            <motion.span
              initial={{ opacity: 0 }}
          ...
          >
            <div className="max-w-2xl">
              ...
              <h2 className="font-serif font-bold text-white text-[clamp(1.8rem,3vw,3rem)] leading-[1.05] tracking-tight mb-4">
                Most clients continue expanding{" "}
                <em className="not-italic text-brand-gold">after the first build.</em>
              </h2>
              <p className="text-slate-400 text-sm leading-relaxed mb-8 font-times">
                Automation compounds over time. Once the foundation is in place, we
                help you add new workflows, monitor performance, and expand coverage
                as your operations grow.
              </p>
              <ul className="space-y-3 mb-10">
                {[
                  "New workflow development and expansion",
              ...
              <p className="text-xs text-slate-600 font-medium uppercase tracking-wider">
                Ongoing engagements from $1,500 – $5,000/month
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section className="relative z-10 py-32">
        ...
        <div ref={ctaRef} className="relative z-10 w-full px-36 flex flex-col items-center text-center">
          ...
          >
            ...
            <em className="not-italic text-brand-gold">Can Be Automated.</em>
          </motion.h2>
          ...
          >
            Let&apos;s identify what to automate first and build a system that pays for itself.
          </motion.p>
    ...
    <div ref={buildRef}>
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        >
          ...
          <em className="not-italic text-brand-gold">real operations.</em>
        </motion.h2>
        <motion.span
          initial={{ opacity: 0 }}
    ...
    <div ref={ref}>
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        >
          ...
          <em className="not-italic text-brand-gold">delivers results.</em>
        </motion.h2>
        <motion.span
          initial={{ opacity: 0 }}
