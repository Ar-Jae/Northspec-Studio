...
const whoFor = [
  "Businesses launching mobile tools tied to AI or automation",
  "Companies building customer-facing products with mobile access",
  "Teams needing internal mobile apps for field operations or workflows",
  "Founders creating scalable products that require both platform and mobile experiences",
];
...
const whatWeBuild = [
  ...
  },
  {
    ...
    short: "Mobile products designed for reliability, high usability, and growth.",
    bullets: [
      "Consumer and B2B SaaS mobile apps",
      "Retention-focused CX experiences",
      "Branded customer portal applications",
    ],
    accent: "from-purple-500/10 to-transparent",
  },
  {
    number: "04",
    title: "Connected Platform Apps",
...
const steps = [
  {
    ...
    title: "Define workflows, users, and business goals",
    description:
      "We map out exactly how mobile fits into your broader system, ensuring every feature supports a real operational or product objective.",
    detail: "Use-case analysis → User flow mapping → System strategy",
  },
  {
    number: "02",
    phase: "Experience Design",
    title: "Plan the mobile experience and system requirements",
    description:
      "We design the mobile UI/UX and define the backend requirements and integrations needed to power the mobile application.",
    detail: "UX Design → Technical Architecture → Integration Mapping",
  },
  {
    number: "03",
    phase: "Development",
  ...
  },
  {
    ...
    title: "Deploying and scaling your mobile product",
    description:
      "We handle the app store submission process and provide ongoing support to ensure your mobile application continues to perform as your business scales.",
    detail: "App Store Launch → Performance Monitoring → Iterative Updates",
  },
];
...
export default function MobileAppDevelopmentClient() {
  ...
  return (
    <div
      ref={sectionRef}
      className="bg-brand-dark text-white min-h-screen relative overflow-hidden"
    >
      ...
      <section className="relative pt-32 pb-20 px-6 md:px-12 lg:px-24">
        <div className="max-w-7xl mx-auto">
          <SectionLabel>Mobile Product Engineering</SectionLabel>
              ...
              <ul className="space-y-4">
                {outcomes.map((outcome, i) => (
                  <li key={i} className="flex items-start gap-4">
                    ...
                    <span className="text-sm text-slate-300 font-medium italic">{outcome}</span>
                  </li>
                ))}
              </ul>
            </motion.div>
              ...
              >
                ...
                <ul className="space-y-3">
                  {service.bullets.map((bullet, bi) => (
                    <li
                      key={bi}
                      className="flex items-center gap-2 text-[11px] text-slate-500 font-bold uppercase tracking-wider"
                    >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
            ...
            <p className="text-slate-400 max-w-sm text-sm font-medium italic">
              Our mobile development lifecycle ensures that performance and system-wide visibility
      ...
      {/* Why Northspec Section */}
      <section className="py-32 px-6 md:px-12 lg:px-24 bg-white/[0.01] border-y border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-24">
            <div>
              <SectionLabel>Client Focus</SectionLabel>
              <h2 className="text-3xl font-serif font-bold mb-12">Who We Work With.</h2>
            ...
            <div>
              ...
              <h2 className="text-3xl font-serif font-bold mb-12">The Northspec Edge.</h2>
      ...
      <section className="py-32 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-8">
            Deploy Your Mobile Concept.
          </h2>
          <p className="text-slate-400 text-lg mb-12 italic font-medium">
            Take your business or product mobile with performance-oriented engineering. Reach your
            users wherever they are with custom-designed apps and deep-system integrations.
          </p>
          <Button
            as="link"
            href="/contact"
