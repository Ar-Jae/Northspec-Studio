...
const outcomes = [
  "Eliminate repetitive tasks and free up your team's time",
  "Reduce human error and improve operational accuracy",
  "Connect your tools and data into one seamless system",
  "Scale operations without adding headcount",
];

const whoFor = [
  "Businesses relying on manual processes that slow them down",
  "Teams managing data across multiple disconnected tools",
  "Companies looking to scale operations without adding staff",
  "Founders building automation directly into their products",
];
...
const whatWeBuild = [
  {
    ...
    short: "Automate repetitive tasks and internal processes end-to-end.",
    bullets: [
      "Multi-step trigger-based workflows",
      "Internal approval and routing logic",
  ...
  },
  {
    ...
    short: "Connect your software stack into one cohesive, efficient system.",
    bullets: [
  ...
  },
  {
    ...
    short: "Ensure your data flows reliably across every system you use.",
    bullets: [
  ...
  },
  {
    ...
    short: "Leverage AI to enhance workflows and improve decision-making.",
    bullets: [
      "LLM-powered classification and routing",
...
const steps = [
  {
    ...
    title: "Identify inefficiencies and automation opportunities",
    description:
      "We map your current workflows, find the bottlenecks, and define exactly what should be automated and how.",
    detail: "Process audit → Bottleneck mapping → Automation scope",
  },
  {
    number: "02",
    phase: "System Design",
  ...
  },
  {
    number: "03",
    phase: "Build & Deploy",
    title: "Implement and test your automation system",
    description:
      "We build, test, and deploy your automation with full documentation so your team understands what runs and why.",
    detail: "Build → QA testing → Production deploy",
  },
  {
    number: "04",
    phase: "Optimize & Scale",
    title: "Refine and expand automation over time",
    description:
      "Most automation systems grow. We monitor performance, fix edge cases, and expand coverage as your operations evolve.",
    detail: "Monitoring → Refinements → Expansion",
  },
];
    ...
    <div className="relative bg-brand-dark min-h-[40vh]">
      ...
      >
        ...
        >
          ...
          >
            We design and build automation systems that reduce repetitive tasks,
            connect your tools, and streamline the operations holding your business back.
          </motion.p>
            ...
            <div className="grid lg:grid-cols-2 gap-0">
              ...
              <div className="p-12 lg:p-16 border-b lg:border-b-0 lg:border-r border-white/[0.06] flex flex-col justify-center">
                ...
                <h2 className="font-serif font-bold text-white text-[clamp(1.8rem,3vw,3.5rem)] leading-[1.05] tracking-tight mb-4">
                  Priced around the{" "}
                  <em className="not-italic text-brand-gold">work that needs doing.</em>
                </h2>
                <p className="text-slate-400 text-sm leading-relaxed font-times max-w-sm">
                  No hourly surprises. Every automation project is scoped and
                  priced upfront so you know exactly what you&apos;re committing to.
                </p>
              </div>
