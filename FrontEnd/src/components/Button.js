...
const variants = {
  ...
  brand: "bg-brand-gold text-brand-dark border-brand-gold/40",
};
...
export default function Button({
  ...
  const Content = () => (
    <>
      ...
      {/* Circle Layer */}
      <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 bg-[#111111] rounded-[50%] opacity-0 group-hover:w-[150%] group-hover:h-[500%] group-hover:opacity-100 transition-all duration-[800ms] ease-[cubic-bezier(0.19,1,0.22,1)]"></span>
