      ...
      <div className="space-y-6">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8 text-center">
          <div>
            ...
            <p className="text-sm text-slate-400 mt-2">30-minute discovery call — availability only</p>
          </div>
          <a 
            href={site.calendarUrl} 
            target="_blank" 
            rel="noopener noreferrer"
            className="mt-6 inline-flex text-sm font-medium text-brand-dark bg-gradient-to-r from-brand-gold to-[#B8860B] px-5 py-3 rounded-lg"
          >
            Open Google Booking
          </a>
        </div>
