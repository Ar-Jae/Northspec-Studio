    ...
    <div className="flex-1 overflow-auto rounded-tl-3xl bg-white p-6">
      ...
      <div className="max-w-2xl space-y-8">
        <section>
          ...
          <div className="grid gap-4 rounded-2xl border border-gray-100 p-6">
            <div className="grid gap-2">
              ...
              <input type="text" defaultValue="Admin User" className="rounded-lg border border-gray-200 px-4 py-2 text-sm focus:border-green-500 focus:outline-none" />
            </div>
            <div className="grid gap-2">
              <label className="text-sm font-medium text-gray-700">Email Address</label>
              <input type="email" defaultValue="admin@northspec.studio" className="rounded-lg border border-gray-200 px-4 py-2 text-sm focus:border-green-500 focus:outline-none" />
            </div>
          </div>
        </section>
        ...
        <div className="flex justify-end gap-4">
          ...
          <button className="rounded-lg bg-green-600 px-4 py-2 text-sm font-medium text-white hover:bg-green-700">Save Changes</button>
        </div>
      </div>
    </div>
  );
